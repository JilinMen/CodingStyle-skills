...
- Centralize hyperparameters in a config file or dataclass—never scatter them across the codebase
- Structure training into modular components (data loading, model creation, optimizer setup, training loop, evaluation, logging)
- Ensure every training script is reproducible, traceable, and extensible
